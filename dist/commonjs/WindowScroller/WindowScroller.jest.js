...
describe('WindowScroller', function () {
  ...
  it('should restore pointerEvents on body after IS_SCROLLING_TIMEOUT', function () {
    var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(done) {
  ...
  describe('onScroll', function () {
    it('should trigger callback when window scrolls', function () {
      var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(done) {
        var onScroll;
    ...
    it('should update :scrollTop when window is scrolled', function () {
      var _ref8 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(done) {
    ...
    it('should specify :isScrolling when scrolling and reset after scrolling', function () {
      var _ref9 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(done) {
    ...
    it('should support a custom :scrollingResetTimeInterval prop', function () {
      var _ref10 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(done) {
        var component, rendered;
